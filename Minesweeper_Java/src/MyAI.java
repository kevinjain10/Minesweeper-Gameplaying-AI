...
public class MyAI extends AI {
	...
	//PriorityQueue<myData> poll = new PriorityQueue<myData>();
...
public void findpatterns()
{
	for(int i=1;i<rowDimension-2;i++)
	{
		for(int j=1;j<colDimension-2;j++)
		{
			...
			/*
			//pattern 1221 with flagging below
		   	if (grid[i][j].tile == 2 && grid[i][j-1].tile == 1 && grid[i][j+1].tile == 2 && 
		   		grid[i][j+2].tile == 1 && grid[i-1][j-1].explored ==true && grid[i-1][j].explored ==true && 
		   		grid[i-1][j+1].explored == true && grid[i-1][j+2].explored == true && grid[i+1][j-1].explored ==false && 
		   		grid[i+1][j].explored == false && grid[i+1][j+1].explored ==false && grid[i+1][j+2].explored == false)
			   	   {
			     	  	flagPattern(i+1,j);
		  ...
		  //pattern 1221 with flagging above
		   	if (grid[i][j].tile == 2 && grid[i][j-1].tile == 1 && grid[i][j+1].tile == 2 && 
		   		grid[i][j+2].tile == 1 && grid[i-1][j-1].explored ==false && grid[i-1][j].explored ==false && 
		   		grid[i-1][j+1].explored == false && grid[i-1][j+2].explored == false && grid[i+1][j-1].explored ==true && 
		   		grid[i+1][j].explored == true && grid[i+1][j+1].explored ==true && grid[i+1][j+2].explored == true)
			   	   {
			     	  	flagPattern(i-1,j);
		  ...
		  //pattern 1221 with flagging on left
		   	if (grid[i][j].tile == 2 && grid[i-1][j].tile == 1 && grid[i+1][j].tile == 2 && 
		   		grid[i+2][j].tile == 1 && grid[i-1][j+1].explored ==true && grid[i][j+1].explored == true &&
		   		grid[i+1][j+1].explored == true && grid[i+2][j+1].explored == true && grid[i-1][j-1].explored ==false && 
		   		grid[i][j-1].explored == false && grid[i+1][j-1].explored == false && grid[i+2][j-1].explored == false )
			   	   {
			     	  	flagPattern(i,j-1);
		  ...
		  //pattern 1221 with flagging on right
		   	if (grid[i][j].tile == 2 && grid[i-1][j].tile == 1 && grid[i+1][j].tile == 2 && 
		   		grid[i+2][j].tile == 1 && grid[i-1][j+1].explored ==false && grid[i][j+1].explored ==false && 
		   		grid[i+1][j+1].explored == false && grid[i+2][j+1].explored == false && grid[i-1][j-1].explored == true && 
		   		grid[i][j-1].explored == true && grid[i+1][j-1].explored ==true && grid[i+2][j-1].explored == true )
			   	   {
			     	  	flagPattern(i,j+1);
			     	  	flagPattern(i+1,j+1);
			       }
			...
			/*
		    //pattern 12 with flagging above(x12x)
		   	if (grid[i][j].tile == 1 && grid[i][j+1].tile == 2 && grid[i-1][j-1].explored ==false && grid[i-1][j].explored ==false && 
		   		grid[i-1][j+1].explored == false && grid[i-1][j+2].explored == false && grid[i+1][j-1].explored ==true && 
		   		grid[i+1][j].explored == true && grid[i+1][j+1].explored == true && grid[i+1][j+2].explored == true && 
		   		grid[i][j-1].explored == true && grid[i][j+2].explored == true)
			   	   {
		   			    neighbour.add(grid[i-1][j-1]);
			     	  	flagPattern(i-1,j+2);
			       }
		  ...
		  //pattern 12 with flagging below
		   	if (grid[i][j].tile == 1 && grid[i][j+1].tile == 2 && grid[i-1][j-1].explored ==true && grid[i-1][j].explored ==true && 
		   		grid[i-1][j+1].explored == true && grid[i-1][j+2].explored == true && grid[i+1][j-1].explored ==false && 
		   		grid[i+1][j].explored == false && grid[i+1][j+1].explored == false && grid[i+1][j+2].explored == false && 
		   		grid[i][j-1].explored ==true && grid[i][j+2].explored == true)
			   	   {
		  ...
		  //pattern 12 with flagging on right
		   	if (grid[i][j].tile == 1 && grid[i+1][j].tile == 2 && grid[i-1][j-1].explored ==true && grid[i][j-1].explored ==true && 
		   		grid[i+1][j-1].explored == true && grid[i+2][j-1].explored == true && grid[i-1][j+1].explored ==false && 
		   		grid[i][j+1].explored == false && grid[i+1][j+1].explored ==false && grid[i+2][j+1].explored == false && 
		   		grid[i-1][j].explored == true && grid[i+2][j].explored == true)
			   	   {
		   				neighbour.add(grid[i-1][j+1]);
			     	  	flagPattern(i+2,j+1);
			       }
		   	
		  //pattern 12 with flagging on left
		   	if (grid[i][j].tile == 1 && grid[i+1][j].tile == 2 && grid[i-1][j-1].explored == false && grid[i][j-1].explored ==false && 
		   		grid[i+1][j-1].explored == false && grid[i+2][j-1].explored == false && grid[i-1][j+1].explored == true &&
		   		grid[i][j+1].explored == true && grid[i+1][j+1].explored == true && grid[i+2][j+1].explored == true && 
		   		grid[i-1][j].explored == true && grid[i+2][j].explored == true)
			   	   {
	...
	for(int i=1;i<rowDimension-1;i++)
	{
		...
		{   
			...
			/*
			//pattern 131 triangle flagging right top
			if(grid[i][j].tile==3 && grid[i+1][j].tile==1 && grid[i][j-1].tile==1 && grid[i+1][j-1].explored==true &&
			   grid[i-1][j-1].explored==false && grid[i-1][j].explored==false && grid[i-1][j+1].explored==false &&	
			   grid[i][j+1].explored==false && grid[i+1][j+1].explored==false)
			{
				flagPattern(i-1,j+1);
			}
			//pattern 131 triangle flagging right bottom
			if(grid[i][j].tile==3 && grid[i-1][j].tile==1 && grid[i][j-1].tile==1 && grid[i-1][j-1].explored==true &&
			   grid[i+1][j-1].explored==false && grid[i+1][j].explored==false && grid[i+1][j+1].explored==false &&	
			   grid[i][j+1].explored==false && grid[i-1][j+1].explored==false)
			{
			...
			//pattern 131 triangle flagging left top
			if(grid[i][j].tile==3 && grid[i][j+1].tile==1 && grid[i+1][j].tile==1 && grid[i+1][j+1].explored==true &&
			   grid[i-1][j-1].explored==false && grid[i-1][j].explored==false && grid[i-1][j+1].explored==false &&	
			   grid[i][j-1].explored==false && grid[i+1][j-1].explored==false)
			{
				flagPattern(i-1,j-1);
			}
			//pattern 131 triangle flagging left bottom
			if(grid[i][j].tile==3 && grid[i][j+1].tile==1 && grid[i-1][j].tile==1 && grid[i-1][j+1].explored==true &&
			   grid[i+1][j-1].explored==false && grid[i+1][j].explored==false && grid[i+1][j+1].explored==false &&	
			   grid[i][j-1].explored==false && grid[i-1][j-1].explored==false)
			{
	...
	for(int i=2;i<rowDimension-2;i++)
	{
		for(int j=2;j<colDimension-2;j++)
		{
		  ...
		  //pattern 1x1 with flagging above
			...
			/*
			//pattern 23 with flagging above
		   	if (grid[i][j].tile == 3 && grid[i][j-1].tile == 2 && grid[i-1][j-1].explored ==false && grid[i-1][j].explored == 
		   		false && grid[i-1][j+1].explored == false && grid[i-1][j+2].explored ==false && grid[i+1][j-1].explored == false && 
		   		grid[i+1][j].explored == true && grid[i+1][j+1].explored ==true && grid[i+1][j+2].explored ==true && 
		   		grid[i][j+1].explored ==true && grid[i][j+2].explored == true && grid[i-1][j-2].explored==false && grid[i][j-2].explored==false &&
		   		grid[i+1][j-2].explored==false)
			   	   {
			     	  	flagPattern(i-1,j+1);
			     	  	flagPattern(i+1,j-1);
			     	  	neighbour.add(grid[i-1][j-2]);
...
public void startSetup()
{
	...
	//if(grid[presentX-1][presentY-1].tile!=0 && listFlag==1)//add non-zero tiles to arraylist
	//{
	//nonZeros.add(grid[presentX-1][presentY-1]);
	//}
}
...
public void flagMines()
{
	if(neighbour.isEmpty()) //This function flags the tile which is the only neighbor of 1
	{
		...
		for(myData m: nonZeros)
		{
			...
			//boolean minus = notMinus(m.exploredX,m.exploredY);
...
public static class myData /*implements Comparator<myData>*/{
